...
############################################################################################
##
## Extension Attribute script to fetch Serial Number and the created credentials
##
###########################################
...
serial=`system_profiler SPHardwareDataType | awk '/Serial/ {print $4}' | tr '[A-Z]' '[K-ZA-J]' | tr 0-9 4-90-3 | base64`
echo "Serial: $serial"
